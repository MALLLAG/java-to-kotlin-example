package com.example.demo.openToSealed.geo

import com.example.demo.openToSealed.itinerary.*;
...
private val Attraction.mapOverlay
    get() =
        PointOverlay(
            position = location.position,
            text = description,
...
private val RestaurantBooking.mapOverlay
    get() =
        PointOverlay(
            id = id,
            position = location.position,
